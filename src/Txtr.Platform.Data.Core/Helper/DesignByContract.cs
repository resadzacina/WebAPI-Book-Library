...
namespace Txtr.Platform.Data.Core
{
    /// <summary>
    ...
    public sealed class Check
    {
        ...
        /// <summary>
        /// Precondition check - argument should not be null.
        /// </summary>
        /// <param name="argument">argument that should not be null.</param>
        /// <param name="argumentName">argument name</param>
        public static void IsNotNull( object argument, string argumentName )
        {
            Require( argument != null, string.Format( "{0} must not be null.", argumentName ) );
        }
